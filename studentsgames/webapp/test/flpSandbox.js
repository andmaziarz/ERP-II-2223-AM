		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Students Games",
									"targetURL": "#studentsgames-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"studentsgames-display": {
								"semanticObject": "studentsgames",
								"action": "display",
								"description": "A Fiori application for Students Games",
								"title": "Students Games",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=studentsgames",
									"url": sap.ui.require.toUrl("studentsgames")
								}
							}
						}
					}
